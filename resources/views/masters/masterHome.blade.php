            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="/insertnews" >Insert news <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href="/about" class="footer_last_part_menu">About</a>
                <a href="/contact" class="footer_last_part_menu">Contact</a>
                <a href="/blog" class="footer_last_part_menu">Latest News</a></div>
        </div>
    </div>
</div>
...
<script>
    ...
    {
        document.body.setAttribute("class","single");
    }
</script>
</body>
</html>
